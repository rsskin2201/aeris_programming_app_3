...
const formSchema = z.object({
  ...
  qualityCompany: z.string().min(1, 'La empresa es requerida.'),
...
export function InspectorForm({ inspector, onClose }: InspectorFormProps) {
  ...
  return (
    <DialogContent className="sm:max-w-[600px]">
      <DialogHeader>
        <DialogTitle>{isEditMode ? 'Editar' : 'Crear'} Inspector</DialogTitle>
        <DialogDescription>
            {isEditMode ? 'Modifica los datos del inspector.' : 'Completa el formulario para dar de alta un nuevo inspector.'}
        </DialogDescription>
      </DialogHeader>
      <Form {...form}>
