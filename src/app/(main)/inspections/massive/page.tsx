...
import { MANUAL_PROGRAMACION_OPTIONS, TIPO_MDD, MERCADO, TIPO_INSPECCION_MASIVA } from "@/lib/form-options";
...
export default function MassiveInspectionPage() {
  ...
  }, [user, zone, isCollaborator, collaboratorCompany, searchParams, form]);
